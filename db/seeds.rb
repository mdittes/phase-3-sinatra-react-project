...
Note.create(comment: "Too rural", state_id: 1)
Note.create(comment: "Too cold, but legal weed " , state_id: 2)
Note.create(comment: "Dry heat, no thanks " , state_id: 3)
Note.create(comment: "Pretty nifty " , state_id: 32)
Note.create(comment: "Don't hate it... " , state_id: 23)

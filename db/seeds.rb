...
louisiana_temp = Temperature.create(temperature: 67.2000, temp_scale: "warm", ranking: 3)
texas_temp = Temperature.create(temperature: 65.8000, temp_scale: "warm", ranking: 4)
georgia_temp = Temperature.create(temperature: 64.3000, temp_scale: "warm", ranking: 5)
mississippi_temp = Temperature.create(temperature: 64.3000, temp_scale: "warm", ranking: 6)
alabama_temp = Temperature.create(temperature: 63.7000, temp_scale: "warm", ranking: 7)
south_carolina_temp = Temperature.create(temperature: 63.4000, temp_scale: "warm", ranking: 8)
arizona_temp = Temperature.create(temperature: 61.1000, temp_scale: "warm", ranking: 9)
arkansas_temp = Temperature.create(temperature: 61.1000, temp_scale: "warm", ranking: 10)
oklahoma_temp = Temperature.create(temperature: 60.4000, temp_scale: "warm", ranking: 11)
north_carolina_temp = Temperature.create(temperature: 59.6000, temp_scale: "warm", ranking: 12)
california_temp = Temperature.create(temperature: 59.1000, temp_scale: "warm", ranking: 13)
tennessee_temp = Temperature.create(temperature: 58.5000, temp_scale: "warm", ranking: 14)
kentucky_temp = Temperature.create(temperature: 56.4000, temp_scale: "warm", ranking: 15)
delaware_temp = Temperature.create(temperature: 56.3000, temp_scale: "warm", ranking: 16)
virginia_temp = Temperature.create(temperature: 56.1000, temp_scale: "warm", ranking: 17)
maryland_temp = Temperature.create(temperature: 55.5000, temp_scale: "moderate", ranking: 18)
missouri_temp = Temperature.create(temperature: 55.3000, temp_scale: "moderate", ranking: 19)
kansas_temp = Temperature.create(temperature: 55.1000, temp_scale: "moderate", ranking: 20)
new_mexico_temp = Temperature.create(temperature: 54.5000, temp_scale: "moderate", ranking: 21)
new_jersey_temp = Temperature.create(temperature: 53.6000, temp_scale: "moderate", ranking: 22)
illinois_temp = Temperature.create(temperature: 52.7000, temp_scale: "moderate", ranking: 23)
west_virginia_temp = Temperature.create(temperature: 52.7000, temp_scale: "moderate", ranking: 24)
indiana_temp = Temperature.create(temperature: 52.5000, temp_scale: "moderate", ranking: 25)
ohio_temp = Temperature.create(temperature: 51.8000, temp_scale: "moderate", ranking: 26)
nevada_temp = Temperature.create(temperature: 51.1000, temp_scale: "moderate", ranking: 27)
rhode_island_temp = Temperature.create(temperature: 50.8000, temp_scale: "moderate", ranking: 28)
connecticut_temp = Temperature.create(temperature: 50.0000, temp_scale: "moderate", ranking: 29)
pennsylvania_temp = Temperature.create(temperature: 49.6000, temp_scale: "moderate", ranking: 30)
nebraska_temp = Temperature.create(temperature: 49.5000, temp_scale: "moderate", ranking: 31)
utah_temp = Temperature.create(temperature: 49.3000, temp_scale: "moderate", ranking: 32)
massachusetts_temp = Temperature.create(temperature: 48.9000, temp_scale: "moderate", ranking: 33)
iowa_temp = Temperature.create(temperature: 48.4000, temp_scale: "moderate", ranking: 34)
oregon_temp = Temperature.create(temperature: 48.0000, temp_scale: "moderate", ranking: 35)
washington_temp = Temperature.create(temperature: 47.4000, temp_scale: "moderate", ranking: 36)
colorado_temp = Temperature.create(temperature: 46.3000, temp_scale: "moderate", ranking: 37)
new_york_temp = Temperature.create(temperature: 46.1000, temp_scale: "moderate", ranking: 38)
south_dakota_temp = Temperature.create(temperature: 45.8000, temp_scale: "cool", ranking: 39)
michigan_temp = Temperature.create(temperature: 45.3000, temp_scale: "cool", ranking: 40)
new_hampshire_temp = Temperature.create(temperature: 44.2000, temp_scale: "cool", ranking: 41)
idaho_temp = Temperature.create(temperature: 44.0000, temp_scale: "cool", ranking: 42)
wisconsin_temp = Temperature.create(temperature: 44.0000, temp_scale: "cool", ranking: 43)
vermont_temp = Temperature.create(temperature: 43.2000, temp_scale: "cool", ranking: 44)
montana_temp = Temperature.create(temperature: 42.6000, temp_scale: "cool", ranking: 45)
wyoming_temp = Temperature.create(temperature: 42.3000, temp_scale: "cool", ranking: 46)
maine_temp = Temperature.create(temperature: 41.9000, temp_scale: "cool", ranking: 47)
minnesota_temp = Temperature.create(temperature: 41.8000, temp_scale: "cool", ranking: 48)
north_dakota_temp = Temperature.create(temperature: 41.1000, temp_scale: "cool", ranking: 49)
alaska_temp = Temperature.create(temperature: 28.1000, temp_scale: "cool", ranking: 50)
